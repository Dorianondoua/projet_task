...
import { MoreHorizontal, UserPlus, Edit2,LogOut, X } from 'react-feather'
...
const Main = () => {    
    ...
    const removeList = (index) => {
        ...
        newList.splice(index, 1); // Supprime la liste à l'index spécifié
                ...
                {bdata.list && bdata.list.map((x,ind)=>{
                   ...
                   <div className="list-body">
                       <div className='flex justify-between p-1'>
                           <span>{x.title}</span>
                           <button className='hover:bg-gray-500 p-1 rounded-sm' onClick={() => removeList(ind)}>
                               <X size={16}></X>
                           </button>
                       </div>
