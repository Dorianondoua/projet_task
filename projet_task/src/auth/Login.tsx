        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" className="space-y-6" onSubmit={handleLogin} >
            ...
            <div className='mt-8 flex flex-col gap-y-4'>
                    <button 
                        className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-violet-500 rounded-xl text-white font-bold text-lg'><Link to="/home">Se connecter</Link></button>
                    <button
                     onClick={handleGoogleLogin}
                        ...
                        className='flex items-center justify-center gap-2 active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4  rounded-xl text-gray-700 font-semibold text-lg border-2 border-gray-100 '>
                            ...
                            <Link to="/home">Se connecter avec Google</Link> 
                    </button>
                    <div className='mt-8 flex justify-center items-center'>
                    <p className='font-medium text-base'>Vous n'avez pas de compte?</p>
                    <button 
                        className='ml-2 font-medium text-base text-violet-500'><Link to="/register">S'inscrire</Link></button>
